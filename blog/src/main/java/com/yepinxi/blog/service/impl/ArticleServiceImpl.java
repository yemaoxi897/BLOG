...
import com.yepinxi.blog.dao.*;
import com.yepinxi.blog.dto.*;
import com.yepinxi.blog.dao.ArticleDao;
import com.yepinxi.blog.dao.ArticleTagDao;
import com.yepinxi.blog.dao.CategoryDao;
import com.yepinxi.blog.dao.TagDao;
import com.yepinxi.blog.entity.Article;
import com.yepinxi.blog.entity.ArticleTag;
import com.yepinxi.blog.entity.Category;
import com.yepinxi.blog.entity.Tag;
import com.yepinxi.blog.exception.BizException;
import com.yepinxi.blog.service.ArticleService;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.yepinxi.blog.service.ArticleTagService;
import com.yepinxi.blog.service.RedisService;
import com.yepinxi.blog.service.TagService;
import com.yepinxi.blog.strategy.context.SearchStrategyContext;
import com.yepinxi.blog.util.BeanCopyUtils;
import com.yepinxi.blog.util.CommonUtils;
import com.yepinxi.blog.util.PageUtils;
import com.yepinxi.blog.util.UserUtils;
import com.yepinxi.blog.vo.*;
import com.yepinxi.blog.constant.CommonConst;
import com.yepinxi.blog.constant.RedisPrefixConst;
import com.yepinxi.blog.dto.*;
import com.yepinxi.blog.vo.*;
...
import static com.yepinxi.blog.enums.ArticleStatusEnum.DRAFT;
import static com.yepinxi.blog.enums.ArticleStatusEnum.PUBLIC;
...
public class ArticleServiceImpl extends ServiceImpl<ArticleDao, Article> implements ArticleService {
    ...
    public void updateArticleViewsCount(Integer articleId) {
        // 判断是否第一次访问，增加浏览量
        Set<Integer> articleSet = CommonUtils.castSet(Optional.ofNullable(session.getAttribute(CommonConst.ARTICLE_SET)).orElse(new HashSet<>()), Integer.class);
